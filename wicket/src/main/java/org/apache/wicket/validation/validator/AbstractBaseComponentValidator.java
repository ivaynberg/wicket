...
/**
 * A hack that provides both {@link AbstractComponentValidator} and {@link AbstractValidator}
 * functionality
 * 
 * @author igor
 */
/*
 * TODO :| {@link AbstractValidator} should perhaps be deprecated... For now this is a copy paste of
 * that code.
 */
public abstract class AbstractBaseComponentValidator<T> extends AbstractComponentValidator<T>
{
